-- Active: 1760428817313@@localhost@3306@db_network_scanning_system
-- Membuat DB
...
CREATE TABLE IF NOT EXISTS network_scans(
    network_id CHAR(5) NOT NULL PRIMARY KEY,
    network_target VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS network_scan_results(
    result_network_id CHAR(5) NOT NULL PRIMARY KEY,
    network_id CHAR(5) NOT NULL,
